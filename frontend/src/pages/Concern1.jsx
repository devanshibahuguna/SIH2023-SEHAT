      ...
      <div className='w-[100vw]  flex flex-col items-center text-center font-bold bg-bgall h-[calc(100vh-100px)]'>
        ...
        <div className='flex justify-between mt-40'>
          ...
          <div className='flex flex-col justify-center items-center'>
            <Link to='/bhcInfo'><img className='w-[187px] h-[224px] top-[280px] left-[222px] hover:drop-shadow-lg' src={ConsultDoctor} /></Link>
          ...
          <div className='flex flex-col justify-center items-center mx-16'>
            <Link to='/DiabetesGlucose'><img className='w-[187px] h-[224px] top-[280px] left-[222px] hover:drop-shadow-lg' src={bgimg} /></Link>
          ...
          <div className='flex flex-col justify-center items-center mr-16'>
            <Link to='/body'><img className='w-[187px] h-[224px] top-[280px] left-[222px] hover:drop-shadow-lg' src={bgimg} /></Link>
            <div className='w-[256px] h-[33px] top-[539px] left-[207px] font-[600] text-[18px] leading-[33px] mt-3'>Body Health</div>
          </div>

          <div className='flex flex-col justify-center items-center'>
            <Link to='/skinRecord'><img className='w-[187px] h-[224px] top-[280px] left-[222px] hover:drop-shadow-lg' src={bgimg} /></Link>
