...
import frontPagePic from '../assets/FrontPagePic.svg';
import {Link} from 'react-router-dom';

const FrontPage = () => {
  return (
    <div className='w-[100vw] h-[100vh] flex flex-col justify-center items-center bg-bgcolor'>

        {/* circle, language */}
        <div>

            {/* circle */}
            <div className='bg-lightbg w-[391px] h-[391px] top-[-123px] left-[-123px] fixed rounded-full'>
